...
export const aboutText = {
    ...
    description: {
        ...
        en: <>
            <ul>
                <li># Familiar with <FeatureLink link="https://vuejs.org">Vue.js</FeatureLink>. I work with <FeatureLink link="https://react.dev">React</FeatureLink>, mostly.</li>
                <li># Combine <FeatureLink link="https://react.dev">React</FeatureLink> with the following frameworks: <FeatureLink link="https://nextjs.org">Next.js</FeatureLink> and <FeatureLink link="https://redux.js.org">Redux</FeatureLink>.</li>
                <li># Use <FeatureLink link="https://www.typescriptlang.org">TypeScript</FeatureLink> and <FeatureLink link="https://ecma-international.org/publications-and-standards/standards/ecma-262/">JavaScript</FeatureLink> at work</li>
                ...
                <li># Working with <FeatureLink link="https://git-scm.com">Git</FeatureLink> and <FeatureLink link="https://www.docker.com">Docker</FeatureLink></li>
